"""Reproduce the bounded WP-23.6 Cogspire travel proof."""
...
SCRIPT = ROOT / "tools/unreal/verify_wp23_6_cogspire_travel.py"
REPORT = ROOT / "Saved/Diagnostics/WP23_6_cogspire_travel_proof.json"
...
try:
    ...
    print(f"WP-23.6 Cogspire travel slice failed: {exc}", file=sys.stderr)
    raise SystemExit(1)
if proof.get("status") != "PASS":
    print(f"WP-23.6 Cogspire travel proof status: {proof.get('status')}", file=sys.stderr)
    raise SystemExit(1)
