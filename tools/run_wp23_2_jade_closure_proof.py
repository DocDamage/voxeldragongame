...
SCRIPT = (ROOT / "tools/unreal/verify_wp23_2_jade_closure.py").as_posix()
REPORT = ROOT / "Saved/Diagnostics/WP23_2_jade_closure_proof.json"
...
try:
    ...
    print("WP-23.2 PIE proof timed out after 300 seconds.", file=sys.stderr)
    sys.exit(1)
sys.stdout.write(process.stdout)
try:
    result = json.loads(REPORT.read_text(encoding="utf-8"))
except (OSError, json.JSONDecodeError) as exc:
    print(f"WP-23.2 report missing or unreadable: {exc}", file=sys.stderr)
    sys.exit(1)
