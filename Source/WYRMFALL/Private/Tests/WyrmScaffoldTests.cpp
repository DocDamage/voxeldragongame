...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWyrmWherewolfEncounterTest, "WYRMFALL.Scaffold.GloamingWherewolfEncounter",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FWyrmWherewolfEncounterTest::RunTest(const FString& Parameters)
{
    UGameInstance* TestGI = NewObject<UGameInstance>(GetTransientPackage());
    UWyrmGloamingSubsystem* Region = NewObject<UWyrmGloamingSubsystem>(TestGI);
    TestNotNull(TEXT("Gloaming fact owner created"), Region);
    ...
    TestFalse(TEXT("Wherewolf rejects before Pleatherface"), Region->RecordWherewolfResolution());
    TestTrue(TEXT("Arrival prerequisite"), Region->RecordArrival());
    TestTrue(TEXT("Ashgrave prerequisite"), Region->ResolveAshgraveExtractionSeal());
    TestTrue(TEXT("Malvaine prerequisite"), Region->RecordMalvaineResolution(true));
    TestTrue(TEXT("Hollow Twins prerequisite"), Region->RecordHollowTwinsResolution(true));
    ...
    TestTrue(TEXT("Wherewolf commits once"), Region->RecordWherewolfResolution());
    TestFalse(TEXT("Wherewolf duplicate rejects"), Region->RecordWherewolfResolution());
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWyrmScarrieEncounterTest, "WYRMFALL.Scaffold.GloamingScarrieEncounter",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FWyrmScarrieEncounterTest::RunTest(const FString& Parameters)
{
    UGameInstance* TestGI = NewObject<UGameInstance>(GetTransientPackage());
    UWyrmGloamingSubsystem* Region = NewObject<UWyrmGloamingSubsystem>(TestGI);
    TestNotNull(TEXT("Gloaming fact owner created"), Region);
    ...
    TestFalse(TEXT("Scarrie rejects before Annie Wails"), Region->RecordScarrieResolution());
    TestTrue(TEXT("Arrival prerequisite"), Region->RecordArrival());
    TestTrue(TEXT("Ashgrave prerequisite"), Region->ResolveAshgraveExtractionSeal());
    TestTrue(TEXT("Malvaine prerequisite"), Region->RecordMalvaineResolution(true));
    TestTrue(TEXT("Hollow Twins prerequisite"), Region->RecordHollowTwinsResolution(true));
    ...
    TestTrue(TEXT("Scarrie commits once"), Region->RecordScarrieResolution());
    TestFalse(TEXT("Scarrie duplicate rejects"), Region->RecordScarrieResolution());
    TestTrue(TEXT("Scarrie fact recorded"), Region->HasFact(FName(TEXT("gloaming.scarrie_resolved"))));
    TestTrue(TEXT("Scarrie receipt recorded"),
        Region->HasReceipt(FName(TEXT("gloaming.scarrie.living_submission"))));
    TestFalse(TEXT("Bounded horror slice does not complete region"),
        Region->HasFact(FName(TEXT("gloaming.region_complete"))));
    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWyrmChucklesEncounterTest, "WYRMFALL.Scaffold.GloamingChucklesEncounter",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FWyrmChucklesEncounterTest::RunTest(const FString& Parameters)
{
    UGameInstance* TestGI = NewObject<UGameInstance>(GetTransientPackage());
    UWyrmGloamingSubsystem* Region = NewObject<UWyrmGloamingSubsystem>(TestGI);
    TestNotNull(TEXT("Gloaming fact owner created"), Region);
    ...
    TestFalse(TEXT("Chuckles rejects before Scarrie"), Region->RecordChucklesResolution());
    TestTrue(TEXT("Arrival prerequisite"), Region->RecordArrival());
    TestTrue(TEXT("Ashgrave prerequisite"), Region->ResolveAshgraveExtractionSeal());
    TestTrue(TEXT("Malvaine prerequisite"), Region->RecordMalvaineResolution(true));
    TestTrue(TEXT("Hollow Twins prerequisite"), Region->RecordHollowTwinsResolution(true));
    ...
    TestTrue(TEXT("Chuckles commits once"), Region->RecordChucklesResolution());
    TestFalse(TEXT("Chuckles duplicate rejects"), Region->RecordChucklesResolution());
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWyrmFrankNShrineEncounterTest, "WYRMFALL.Scaffold.GloamingFrankNShrineEncounter",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FWyrmFrankNShrineEncounterTest::RunTest(const FString& Parameters)
{
    UGameInstance* TestGI = NewObject<UGameInstance>(GetTransientPackage());
    UWyrmGloamingSubsystem* Region = NewObject<UWyrmGloamingSubsystem>(TestGI);
    TestNotNull(TEXT("Gloaming fact owner created"), Region);
    ...
    TestFalse(TEXT("Frank N. Shrine rejects before Count Dripula"), Region->RecordFrankNShrineResolution());
    TestTrue(TEXT("Arrival prerequisite"), Region->RecordArrival());
    TestTrue(TEXT("Ashgrave prerequisite"), Region->ResolveAshgraveExtractionSeal());
    TestTrue(TEXT("Malvaine prerequisite"), Region->RecordMalvaineResolution(true));
    TestTrue(TEXT("Hollow Twins prerequisite"), Region->RecordHollowTwinsResolution(true));
    ...
    TestTrue(TEXT("Frank N. Shrine commits once"), Region->RecordFrankNShrineResolution());
    TestFalse(TEXT("Frank N. Shrine duplicate rejects"), Region->RecordFrankNShrineResolution());
    TestTrue(TEXT("Frank N. Shrine fact recorded"), Region->HasFact(FName(TEXT("gloaming.frank_n_shrine_resolved"))));
