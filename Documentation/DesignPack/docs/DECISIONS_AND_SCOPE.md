...
| D-23 | Nyxaroth/Dark Dragon uses its own validated profile; Cathedral/cemetery candidates and the required modular horror roster are retained, with original WYRMFALL pun-name aliases for production-facing identities | WP-23.5 NYX-01..05 validates the dragon. The editor fixture validates four Cathedral roles plus Michael Mire; `L_GloamingMarches` validates the supplied foundation, Arrival-to-Ashgrave route, Count Malvaine/Hollow Twins routes, optional Sanguine Strike/Second Turn, two-way travel/save recovery, and all 20 supplied required-horror identities as runtime encounters. The final eleven-identity pass adds Ail-Yen, Bellraiser, Sad Echo, Dreadator, Roastface, the Gravy Daughters, Knit, Canniball, Mum's the Wyrd, Dready Freddie, and Pyre-Midhead using 183 unique parts and distinct 148–220 cm presentations. All 20 required-horror one-time receipts restore through Schema 7 without granting a new Echo or completion. Regional completion stays separately gated. |
