...
| D-23 | Nyxaroth/Dark Dragon is import-feasible but remains fail-closed until a distinct profile and focused PIE proof exist; Cathedral/cemetery candidates and the required modular horror roster are retained, with original WYRMFALL pun-name aliases for production-facing identities | WP-23.5 UE 5.8.2 readiness evidence found a viable dragon import and 331 separate horror body-part meshes. Assembly, animation, collision, visual fit, and provenance remain production gates. |
