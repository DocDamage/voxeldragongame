...
| DRG-DARK | Dark / Nyxaroth | UE 5.8.2 profile proof passed NYX-01..05: `Hip-Local` + 32 followers, one skeleton, distinct 28x34 / 115x155 envelopes, Heartfold, mount/flight, GAS combat/control, living bond, and save identity. The Cathedral/Michael Mire fixture, `L_GloamingMarches` foundation, Arrival-to-Ashgrave route, supplied-Priest Count Malvaine encounter, distinct supplied-Nun Hollow Twins encounter, optional GAS Sanguine Strike/Second Turn, two-way Schema 7 recovery, the 17-part Michael Mire encounter, the 17-part weapon-bearing Machete Mason encounter, the 17-part sword-bearing Pleatherface encounter, the 16-part 205 cm Wherewolf encounter, and the 17-part 176 cm Annie Wails encounter pass | Further required-horror gameplay assemblies before regional completion |
