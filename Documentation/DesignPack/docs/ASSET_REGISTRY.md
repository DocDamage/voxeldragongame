...
| DRG-DARK | Dark / Nyxaroth | UE 5.8.2 profile proof passed NYX-01..05: `Hip-Local` + 32 followers, one skeleton, distinct 28x34 / 115x155 envelopes, Heartfold, mount/flight, GAS combat/control, living bond, and save identity. The Cathedral fixture, `L_GloamingMarches` foundation/routes, Count Malvaine/Hollow Twins, optional GAS Sanguine Strike/Second Turn, two-way Schema 7 recovery, and all 20 supplied required-horror identities now pass as runtime encounters. The final eleven-identity roster proof covers 183 unique supplied parts, distinct 148–220 cm presentations, paired Gravy Daughter staging, GAS living submissions, and one-time ledger recovery | Required-horror roster complete; regional completion closure remains |
