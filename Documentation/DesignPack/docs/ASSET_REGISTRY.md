...
| DRG-DARK | Dark / Nyxaroth | UE 5.8.2 profile proof passed NYX-01..05: `Hip-Local` + 32 followers, one skeleton, distinct 28x34 / 115x155 envelopes, Heartfold, mount/flight, GAS combat/control, living bond, and save identity. The Cathedral/Michael Mire fixture, `L_GloamingMarches` foundation, Arrival-to-Ashgrave route, supplied-Priest Count Malvaine encounter, distinct supplied-Nun Hollow Twins encounter, optional GAS Sanguine Strike/Second Turn, two-way Schema 7 travel/save recovery, and the supplied 17-part 190 cm Michael Mire living-submission encounter also pass; localized shadow effects remain open | Further required-horror gameplay assemblies before regional completion |
